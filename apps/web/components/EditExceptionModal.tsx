...
export function EditExceptionModal({ 
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Edit Exception" widthClass="max-w-2xl">
      {/* Error Display */}
      {errors.length > 0 && (
      ...
      <div className="flex justify-end space-x-3 mt-6">
        <button
          type="button"
          onClick={onClose}
          className="px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
        >
          Cancel
        </button>
        <button
